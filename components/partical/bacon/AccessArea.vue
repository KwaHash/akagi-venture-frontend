  ...
  <div :class="s.container">
    ...
    <div :class="s.inner">
      <div :class="s.addressContainer">
        <p>〒371-0048 群馬県前橋市田口町36番地</p>
        <p :class="s.tel">
          <span>TEL: 027-225-2498</span>
        </p>
        <div :class="s.insta">
          <p>instagram: </p>
          <a href="https://www.instagram.com/bacon.akagi/" target="_blank">
            <img src="/images/about/insta.png" alt="">
          </a>
        </div>
        <a :class="s.button" href="https://goo.gl/maps/kHhNPcocoBrjHg7m6" target="_blank" rel="noopener noreferrer">Google MAP</a>
      </div>
...
.bg {
  ...
  background: #fdf1e3 url('/images/brand/bacon/place/bg.jpg') center no-repeat;
