<template>
  <div id="anchor-takibi" :class="s.container">
    <ThinContainer :class="s.inner">
      <div :class="s.contentsContainer">
        <h2 :class="s.heading">焚き火体験</h2>
          ...
          <div :class="[s.contentsItem, s.isActive]" >
            <div :class="s.contentInner">
              ...
              <div :class="s.smallThumbContainer">
                <img :src="`/images/brand/bacon/takibi/0.jpg`" :class="s.smallThumb" alt="焚き火体験">
              </div>
              <div :class="s.text">
                <div :class="s.table">
                  <div :class="s.tableRow">
                    <div :class="s.headCell">料金</div>
                    <div :class="s.dataCell">
                      ¥3,600／サイト
                      <br>
                      ¥1,100／1人（小学生以上）
                      <br>
                  ...
                  <div :class="s.tableRow">
                    <div :class="s.headCell">人数</div>
                    <div :class="s.dataCell">2〜6名</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div :class="s.sliderContainer">
        <div :class="s.slider">
          <div :class="[s.sliderItem, s.isActive]" >
            <img :src="`/images/brand/bacon/takibi/0.jpg`" alt="">
          </div>
        </div>
      </div>
    </ThinContainer>
