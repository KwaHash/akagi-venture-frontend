  ...
  <div :class="s.container">
    ...
    <div :class="s.inner">
      <div :class="s.addressContainer">
        <p>〒371-0247 群馬県前橋市三夜沢町534</p>
        <p :class="s.tel">
          <span>TEL: 027-283-2983</span>
          <span>FAX: 027-283-2980</span>
        </p>
        <div :class="s.insta">
          <p>instagram: </p>
          <a href="https://www.instagram.com/tontonhiroba/" target="_blank">
            <img src="/images/about/insta.png" alt="">
          </a>
        </div>
        <a :class="s.button" href="https://goo.gl/maps/1VWmHhnrXHceyRjJ6" target="_blank" rel="noopener noreferrer">Google MAP</a>
      </div>
...
.bg {
  ...
  background: #fdf1e3 url('/images/brand/tonton/place/bg.jpg') center no-repeat;
  background-size: cover;
  z-index: 1;

  @include mq.smView {
    transition: transform 10ms linear;
    background-image: url('/images/brand/tonton/place/bg-sp.jpg');
  }
}
